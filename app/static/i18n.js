(function () {
  const translations = {
    de: {
      ...
      'backup.body': 'Sicherungen der Actual-Budget-Datei. Wiederherstellbar in Actual über „Datei importieren“ und dann „Actual“.',
      'backup.retention': 'Aufbewahrung: {daily} tägliche, {weekly} wöchentliche, {monthly} monatliche. Ablage: {directory}',
      'backup.empty': 'Noch keine Backups vorhanden.',
      'backup.create': 'Backup jetzt erstellen',
      'backup.reload': 'Neu laden',
      'backup.delete': 'Löschen',
      'backup.deleteConfirm': 'Backup {name} wirklich löschen?',
      'backup.deleteFailed': 'Backup konnte nicht gelöscht werden',
      'backup.creating': 'Backup wird erstellt',
      'backup.creatingBody': 'Die Actual-Budget-Datei wird heruntergeladen und gesichert...',
      'backup.created': 'Backup erstellt',
      'backup.createdBody': '{name} ({size}). Durch die Rotation entfernt: {removed}.',
      'backup.failed': 'Backup fehlgeschlagen',
      'backup.loadFailed': 'Backups konnten nicht geladen werden',
    ...
    en: {
      ...
      'backup.title': 'Backups', 'backup.body': 'Copies of the Actual budget file. Restore them in Actual through "Import file" and then "Actual".', 'backup.retention': 'Retention: {daily} daily, {weekly} weekly, {monthly} monthly. Stored in {directory}', 'backup.empty': 'No backups yet.', 'backup.create': 'Create backup now', 'backup.reload': 'Reload', 'backup.delete': 'Delete', 'backup.deleteConfirm': 'Really delete backup {name}?', 'backup.deleteFailed': 'Could not delete the backup', 'backup.creating': 'Creating backup', 'backup.creatingBody': 'Downloading and storing the Actual budget file...', 'backup.created': 'Backup created', 'backup.createdBody': '{name} ({size}). Removed by rotation: {removed}.', 'backup.failed': 'Backup failed', 'backup.loadFailed': 'Could not load backups',
