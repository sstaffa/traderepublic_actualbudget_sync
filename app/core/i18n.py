...
TRANSLATIONS = {
    "de": {
        ...
        "backup.invalid_name": "Ungültiger Backup-Name.",
        "backup.not_found": "Das Backup {name} wurde nicht gefunden.",
        ...
        "tr.totp_secret_missing": "Es ist kein TR_TOTP_SECRET gesetzt, daher kann kein Authenticator-Code erzeugt werden.",
        "tr.totp_package_missing": "Das Paket pyotp fehlt, daher kann kein Authenticator-Code erzeugt werden ({error}).",
        "tr.totp_secret_invalid": "TR_TOTP_SECRET konnte nicht gelesen werden. Erwartet wird das Base32-Geheimnis aus der Authenticator-Einrichtung ({error}).",
        ...
        "tr.totp_secret_missing": "TR_TOTP_SECRET is not set, so no authenticator code can be generated.",
        "tr.totp_package_missing": "The pyotp package is missing, so no authenticator code can be generated ({error}).",
        "tr.totp_secret_invalid": "TR_TOTP_SECRET could not be read. The base32 secret from the authenticator setup is expected ({error}).",
    ...
    "en": {
        ...
        "backup.invalid_name": "Invalid backup name.",
        "backup.not_found": "Backup {name} was not found.",
